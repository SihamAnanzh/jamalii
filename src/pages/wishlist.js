...
export const getServerSideProps = async ({ locale }) => ({
  props: {
    ...(await serverSideTranslations(locale, ['home','face','body','wishlist'])),
  },
})
...
const WishlistPage = () => {
  ...
  return (
    <PublicLayout breadcrumb={breadcrumbsData}  subNav={subNav}  headerData={headerData}  footerDta={footerDta} trendingData={trendingData} breadcrumbTitle={w1}>
      <Wishlist  wishlistData={wishlistData} trendingData={trendingData}/>
      {/* <MostViewed /> */}
    </PublicLayout>
  );
};
