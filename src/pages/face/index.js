...
let headerData={ca1 ,ca2,ca3,ca4,home}
 ...
 let mostViewedData={
  ...
  const breadcrumbsData = [
    ...
    {
      label: headerData.ca1,
      path: "/face",
    },
  ];

  return (
    <PublicLayout subNav={subNav} breadcrumb={breadcrumbsData} breadcrumbTitle={headerData.ca1} trendingData={trendingData} headerData={headerData} footerDta={footerDta}>
