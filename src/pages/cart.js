...
export const getServerSideProps = async ({ locale }) => ({
  props: {
    ...(await serverSideTranslations(locale, ['home','face','body','cart'])),
  },
})
...
const CartPage = () => {
  ...
  return (
    <PublicLayout   breadcrumb={breadcrumbsData} subNav={subNav}  headerData={headerData}  footerDta={footerDta} trendingData={trendingData} breadcrumbTitle={cart1}>
