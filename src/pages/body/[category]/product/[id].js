...
let footerDta={
  ...
  let headerData={ca1 ,ca2,ca3,ca4,home}
  let trendingData={
    titleOne,
    titleTow,
    td1,
...
pd9
  ...
  ///
  return (
    <PublicLayout subNav={subNav} breadcrumb={breadcrumbsData} breadcrumbTitle={shop} headerData={headerData} footerDta={footerDta} trendingData={trendingData} >
      <ProductDetails subNav={subNav} productDetail={productDetail} headerData={headerData} footerDta={footerDta} trendingData={trendingData}/>
      {/* <MostViewed mostViewedData={mostViewedData} additionalClass='product-viewed ' headerData={headerData} footerDta={footerDta} trendingData={trendingData} /> */}
