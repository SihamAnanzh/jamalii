...
let categoryData=[
 ...
 let mostViewedData={
  ...
  return (
    <PublicLayout breadcrumb={breadcrumbsData} breadcrumbTitle={shop} subNav={subNav} breadcrumb={breadcrumbsData} breadcrumbTitle={headerData.ca3} trendingData={trendingData} headerData={headerData} footerDta={footerDta}>
      <ProductDetails />
      <MostViewed />
    </PublicLayout>
  );
