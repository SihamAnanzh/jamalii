...
// import categoryData from '../../data/category/bodyCategory'
...
//   ];
//   return (
//     <PublicLayout breadcrumb={breadcrumbsData} breadcrumbTitle="face" headerData={headerData} footerDta={footerDta}>
...
let subNav={
  ...
  return (
    <PublicLayout subNav={subNav} breadcrumb={breadcrumbsData} breadcrumbTitle={headerData.ca3} trendingData={trendingData} headerData={headerData} footerDta={footerDta}>
