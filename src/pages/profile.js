...
export const getServerSideProps = async ({ locale }) => ({
  props: {
    ...(await serverSideTranslations(locale, ['home','face','body','profile'])),
  },
})
...
let profile1=t('profile:profile-1')
let profile2=t('profile:profile-2')
let profile3=t('profile:profile-3')
let profile4=t('profile:profile-4')
let profile5=t('profile:profile-5')

let pr1=t('profile:pr-1')
let pr2=t('profile:pr-2')
let pr3=t('profile:pr-3')
let pr4=t('profile:pr-4')
let pr5=t('profile:pr-5')
let pr6=t('profile:pr-6')
let pr7=t('profile:pr-7')
let pr8=t('profile:pr-8')
...
const breadcrumbsData = [
  ...
  return (
    <PublicLayout  breadcrumb={breadcrumbsData} subNav={subNav}  headerData={headerData}  footerDta={footerDta} trendingData={trendingData} breadcrumbTitle={profile1}>
      <Profile disData={disData} profileData={profileData} trendingData={trendingData}/>
    </PublicLayout>
  );
};
