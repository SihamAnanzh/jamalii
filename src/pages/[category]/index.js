...
export const getServerSideProps = async ({ locale }) => ({
  props: {
    ...(await serverSideTranslations(locale, ['home','face'])),
  },
})
...
let subNav={
  ...
  return (
    <PublicLayout subNav={subNav} breadcrumb={breadcrumbsData} breadcrumbTitle="face" headerData={headerData} footerDta={footerDta} trendingData={trendingData}>
...
//     const productsData=fetch(`${baseUrl}/og/categories`)
