    ...
    <>
      ...
      <div className='products-item'>
        <div className='products-item__type'>
          {isSale && <span className='products-item__sale'>{trendingData.td4}</span>}
          {isNew && <span className='products-item__new'>{trendingData.td5}</span>}
        </div>
        ...
        <div className='products-item__info'>
          ...
          <span>{oldPrice && `${trendingData.td6}${oldPrice}`}</span>{trendingData.td6+price}
         </span>
        </div>
      </div>
